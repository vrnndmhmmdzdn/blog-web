                ...
                <div class="border border-gray-300 py-5 px-8">
                    <div class="w-full py-3 flex flex-col gap-5" style="scrollbar-width: none;">
                        <div class="flex flex-row items-center gap-1">
                            ...
                            <span>/</span>
                            <p class="text-sm text-gray-700 font-normal hover:text-[#E20612]">Author
                            </p>
                        </div>
                        <div class="px-3 py-1 text-sm text-white font-normal bg-blue-600 w-fit rounded-sm">Author</div>
