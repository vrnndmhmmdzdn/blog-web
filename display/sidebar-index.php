        ...
        <div class="relative">
            <div id="populer" class="absolute top-0 right-0 left-0 scale-100 transition">
                <?php foreach ($homes->HotNews() as $hotNews): ?>
                    <a href="section/detail-blog.php?id=<?= $hotNews['post_id'] ?>" class="my-5 px-7 flex flex-row gap-3">
            ...
            <div id="terbaru" class="absolute top-0 right-0 left-0 scale-0 transition">
                <?php foreach ($homes->RecentNews() as $recentNews): ?>
                    <a href="section/detail-blog.php?id=<?= $recentNews['post_id'] ?>" class="my-5 px-7 flex flex-row gap-3">
            ...
            <div class="visible scale-0 transition">
                <div class="my-5 px-7 flex flex-row gap-3">
                    <div class="max-w-32"><img src="img/DSC_0383.JPG" class="w-full"></div>
                    <div class="py-1">
                        <h5 class="text-gray-800 font-semibold text-base">Selalu berdoa dalam setiap kondisi
                        </h5>
                        <div class="flex flex-row items-center gap-1 w-max">
                            <i class="ph ph-clock-afternoon text-gray-600 text-sm font-normal"></i>
