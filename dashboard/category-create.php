                    ...
                    <div class="container full-container py-5 flex flex-col gap-6">
                        <div class="card">
                            <div class="card-body flex flex-col gap-6">
                                ...
                                <p class="text-sm">Insert new acticle category</p>
                                <div class="card">
                                    <div class="card-body">
                                        <form class="flex flex-col gap-6" enctype="multipart/form-data" action="" method="post">
                                            <div>
                                                ...
                                                <input type="text" name="category_name" id="input-label-with-helper-text"
                                                    class="py-3 px-4 block w-full border-gray-200 rounded-md text-sm focus:border-blue-600 focus:ring-0 "
                                                    aria-describedby="hs-input-helper-text">
                                                <p class="text-sm  text-gray-500 mt-2" id="hs-input-helper-text">Category will saparate article</p>
                                            </div>
                                            <div>
                                                <label for="input-label-with-helper-text"
                                                    class="block text-sm font-semibold mb-2 text-gray-600">Icon</label>
                                                <input type="file" name="icon" id="input-label-with-helper-text" required
