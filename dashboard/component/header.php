...
<header class="container full-container w-full text-sm py-5 xl:px-9 px-5">
    ...
    <nav class=" w-full bg-gray-800  flex items-center justify-between" aria-label="Global">
        ...
        <div class="flex items-center gap-4">
            <div class="btn font-medium py-2" aria-current="page">Halo, <?= $_SESSION['user_name'] ?> !</div>
            <div class="hs-dropdown relative inline-flex [--placement:bottom-right] sm:[--trigger:hover]">
                <a class="relative hs-dropdown-toggle cursor-pointer align-middle rounded-full">
                    <img class="object-cover w-9 h-9 rounded-full" src="../public/profile/<?= $_SESSION['user_img'] ?>" alt=""
                        aria-hidden="true">
                </a>
                <div class="card hs-dropdown-menu transition-[opacity,margin] border border-gray-400 rounded-[7px] duration hs-dropdown-open:opacity-100 opacity-0 mt-2 min-w-max  w-[200px] hidden z-[12]"
                    ...
                    <div class="card-body p-0 py-2">
                        ...
                        <form action="" method="post" class="px-4 mt-[7px] grid">
                            <button type="submit" name="logout" class="btn-outline-primary w-full hover:bg-blue-600 hover:text-white">Logout</button>
                        </form>
