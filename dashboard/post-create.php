    ...
    if (gettype($result) == "string") {
        ...
        document.addEventListener('DOMContentLoaded', function() {
            Swal.fire({
                position: 'center-center',
                icon: 'success',
                title: 'Successfully added a new article',
                showConfirmButton: false,
                timer: 2000
            });
            setTimeout(() => {
                                    ...
                                    <div class="card-body">
                                        <form class="flex flex-col gap-6" enctype="multipart/form-data" action="" method="post">
                                            ...
                                            <div>
                                                ...
                                                <input type="text" name="post_title" id="input-label-with-helper-text"
                                            ...
                                            <div class="wfull">
                                                <label class="inline-block text-sm text-gray-600" for="Multiselect">Select multiple roles</label>
