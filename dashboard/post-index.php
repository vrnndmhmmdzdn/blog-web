...
$postsPage = $posts->Paginate($start, $limit);
?>
<!DOCTYPE html>
<html lang="en">
...
<body class="DEFAULT_THEME bg-white">
            ...
            <div class="card">
              <div class="card-body flex flex-col gap-6">
                <div class="flex flex-row justify-between items-center">
                  <h6 class="text-lg text-gray-600 font-semibold">Post Pages</h6>
                </div>
  ...
  <script>
    $('#search').on('keyup', function() {
      $('#liveSearch').load(`./component/liveSearch/post.php?key=` + $('#search').val());
    });
    ...
    function trash(e, id) {
      ...
      swalWithBootstrapButtons.fire({
        ...
        if (result.isConfirmed) {
          window.location.href = `component/post-delete.php?id=${id}`
        } else if (
