...
if (isset($_POST['login'])) {
    $login = $users->Login($_POST['user_email'], $_POST['user_password']);
                ...
                <div class=" w-full card-body">
                    ...
                    <form action="" method="post">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" id="forUsername" name="user_email"
                        ...
                        <!-- button -->
                        <div class="grid my-6">
                            <button name="login" class="btn py-[10px] text-base text-white font-medium hover:bg-blue-700">Sign In</button>
                        </div>
